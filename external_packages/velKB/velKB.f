	subroutine cpeds_vdrt32(dj, ra, dec, aLMST, Vsun, Vobs, Vtot)
...
c ro=sqrt(x^2+y^2), along=atan(y,x)=0.32400392423rad=pi*0.103133652246
	ro=3838.2701869d0	! skladowa rownikowa w km
	albypi=0.103133652246d0	! along/pi
