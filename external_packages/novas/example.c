 ...
 */
   ...
   const short int day = 10;
   const short int leap_secs = 35;
   const short int accuracy = 0;
   short int error = 0;
   short int de_num = 0;
   
   const double hour = 13.75;
//   const double ut1_utc = -0.387845;
   const double ut1_utc = 0.0;
   
   const double latitude = 53.085;
   const double longitude = 18.562;
   const double height = 133.0;
...
*/
   ...
   printf("leap seconds: %i \n",leap_secs);
   printf ("UTC and TT and UT1 Julian Dates and Delta-T:\n");
   printf ("%15.8f     %15.8f        %15.8f        %16.11f\n", jd_utc, jd_tt, jd_ut1, delta_t);
   printf ("\n");
...
*/
   ...
   printf ("%15.10f [h]    %15.10f        %15.12f\n", ra, dec, dis);
   printf ("%15.10f [h]    %15.10f        %15.12f\n", rat, dect, dist);
   printf ("%15.10f [deg]  %15.10f        %15.12f\n", rat*15.0, dect, dis);
